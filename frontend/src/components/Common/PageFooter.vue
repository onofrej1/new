...
<b-navbar type="dark" variant="black" toggleable>
    <b-container>
        ...
        <div class="float-right navbar-btn btn-sm">
            <a href="http://youtu.be/zJahlKPCL9g" style="color: black">
              webstránka:<span class="glyphicon glyphicon-envelope" />
              erikonofrej@maratonfurca.sk
            </a>
            <a href="http://www.toplist.sk/" target="_top">
                <img src="http://toplist.sk/count.asp?id=1254971&logo=mc" border="0" alt="TOPlist" width="88" height="60" />
            </a>
        </div>
    </b-container>
</b-navbar>
